...
Available tools:
- simulate_sir(beta, gamma, S0, I0, R0, days): simulate the SIR dynamics and return daily values.
...
- When fitting, report fitted parameters (beta, mu, I0, detection_fraction), R0 and RMSE.
