...
with gr.Blocks(title="Epidem-IA", theme=gr.themes.Soft()) as demo:

    gr.Markdown("# Chat with Epiderm-IA epidemiological agent 🦠🧪🔬💉🧬🩺  and see its thoughts 💭")

    with gr.Row():
        with gr.Column(scale=1):
            gr.Image("epidemia.png", show_label=False)
